...
namespace VTraktate.Repository.SnapshotProviders
{
    public abstract class ProviderSnapshotProviderBase
    {
        ...
        protected IQueryable<ProviderSnapshotBase> GetProviderSnapshots(DateTime? date = null)
        {
            ...
            var result = from provider in Context.Providers
                         // + promotions
                         ...
                         join item in currentEmployeeCalendarPeriods on provider.Id equals item.ProviderId into myEmployeeCalendarPeriods
                         ...
                         join item in currentFreelanceCalendarPeriods on provider.Id equals item.ProviderId into myFreelanceCalendarPeriods
